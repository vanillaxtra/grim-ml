...
public class GrimACFabric1170LoaderPlugin extends GrimACFabricIntermediaryLoaderPlugin {
  ...
  protected GrimACFabric1170LoaderPlugin(
    ...
    super(commandArguments, playerFactory, platformServer, fabricMessageUtil, fabricConversionUtil);
  }
