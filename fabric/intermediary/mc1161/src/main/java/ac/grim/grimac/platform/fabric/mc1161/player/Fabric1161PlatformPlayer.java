...
public class Fabric1161PlatformPlayer extends AbstractFabricPlatformPlayer<ServerPlayer> {
  ...
  public Sender getSender() {
    return GrimACFabricIntermediaryLoaderPlugin.LOADER
        .getFabricSenderFactory()
        .wrap(serverPlayer().createCommandSourceStack());
  }
  ...
  public void kickPlayer(String textReason) {
    serverPlayer()
        ...
        .disconnect(
            (Component)
                GrimACFabricIntermediaryLoaderPlugin.LOADER
                    .getFabricMessageUtils()
                    .textLiteral(textReason));
  }
